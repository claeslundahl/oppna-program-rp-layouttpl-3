<div class="rp-columns rp-columns-system-page" id="main-content" role="main">
	...
	<div class="rp-main-layout-wrap">
		...
		<div class="portlet-layout row-fluid">
			...
			<div class="portlet-column portlet-column-first portlet-column-last rp-sidebar rp-sidebar-hidden span4" id="column-sidebar">
